...
class Transactions
{
    ...
    **************************************************/
    public void displayAccountAmount(List<Account> accounts, int accountLocation, AccountList accountList)
    {
    ...
    **************************************************/
    public void withdrawlAmount(List<Account> accounts, int accountLocation, AccountList accountList)
    {
        accounts = accountList.getAccountList();
        bool valid = false;
    ...
    **************************************************/
        public void depositAmount(List<Account> accounts, int accountLocation, AccountList accountList)
    {
        accounts = accountList.getAccountList();
        bool valid = false;
    ...
    **************************************************/
    public void getRecentTrasactions(List<Account> accounts, int accountLocation, AccountList accountList)
    {
        accounts = accountList.getAccountList();
        int num = 1;
        Console.Write(accounts[accountLocation].Transactions.Count);
    ...
    **************************************************/
        public void getReport(List<Account> accounts, int accountLocation, AccountList accountList)
    {
        accounts = accountList.getAccountList();
        Console.WriteLine("***BANK REPORT***");
        Console.WriteLine("Your Amount is: " + accounts[accountLocation].accountAmount);
        getRecentTrasactions(accounts, accountLocation, accountList);
